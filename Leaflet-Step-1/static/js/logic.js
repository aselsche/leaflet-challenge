...
let satelliteMap = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
    attribution: "<a href=\"https://www.mapbox.com/about/maps/\">(c)Mapbox</a>, <a href=\"http://www.openstreetmap.org/copyright\">(c)OpensStreetMap</a>, <a href=\"https://www.mapbox.com/map-feedback\">(c)Improve this Map</a>",
    maxZoom: 18,
    id: "mapbox.satellite",
    accessToken: API_KEY
});
...
// let grayscaleMap = L.tileLayer("https://api.tiles.mapbox.com/v10/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
//     attribution: "<a href=\"https://www.mapbox.com/about/maps/\">(c)Mapbox</a>, <a href=\"http://www.openstreetmap.org/copyright\">(c)OpensStreetMap</a>, <a href=\"https://www.mapbox.com/map-feedback\">(c)Improve this Map</a>",
//     maxZoom: 18,
//     id: "mapbox.light",
//     accessToken: API_KEY
